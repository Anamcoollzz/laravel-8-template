            ...
            <td style="text-align:center;">
              <a href="{{ config('app.url') }}" title="logo" target="_blank">
                <img width="60" src="{{ $_logo_url = \App\Repositories\SettingRepository::logoUrl() }}"
                  title="{{ $_app_name = \App\Models\Setting::where('key', 'application_name')->first()->value ?? config('app.name') }}"
                  alt="logo">
              </a>
            </td>
          </tr>
                ...
                <tr>
                  <td style="padding:0 35px;">
                    ...
                    <p style="color:#455056; font-size:15px;line-height:24px; margin:0;">
                      Terima kasih telah bergabung dengan kami. Untuk menggunakan akun anda dalam sistem, silakan klik
                      tautan berikut untuk memverifikasi akun.
                    </p>
