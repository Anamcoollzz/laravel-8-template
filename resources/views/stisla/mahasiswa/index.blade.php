  ...
  <div class="section-body">
    <div class="row">
      <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
              ...
              <div class="card-header-action">
                ...
                @include('stisla.includes.form.buttons.btn-add', ['link'=>route('mahasiswas.create')])
                {{-- @endcan --}}
              </div>
            </div>
            <div class="card-body">
                  ...
                  <tbody>
                    @foreach ($data as $item)
                      <tr>
                        ...
                        <td>
                          {{-- @can('Mahasiswa Ubah') --}}
                          @include('stisla.includes.form.buttons.btn-edit', ['link'=>route('mahasiswas.edit',
                          [$item->id])])
                          {{-- @can('Mahasiswa Hapus') --}}
                          @include('stisla.includes.form.buttons.btn-delete', ['link'=>route('mahasiswas.destroy',
                          [$item->id])])
                          {{-- @endcan --}}
                        </td>
                      </tr>
        ...
        @else
          @include('stisla.includes.empty-state', ['title'=>'Data '.$title, 'icon'=>'fa
          fa-users','link'=>route('mahasiswas.create')])
        @endif
      </div>
...
@push('modals')
  @include('stisla.includes.modals.modal-import-excel', ['formAction'=>route('mahasiswas.import-excel'),
