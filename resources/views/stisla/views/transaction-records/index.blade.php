              ...
              <table class="table table-striped" id="datatable">
                <thead>
                  <tr>
                    ...
                    <th class="text-center">{{ __('Tanggungan') }}</th>
                    ...
                    <th class="text-center">{{ __('Tanggungan') }}</th>
                    <th class="text-center">{{ __('Terbayar') }}</th>
                    <th class="text-center">{{ __('Kurang') }}</th>
                ...
                <tbody>
                  @foreach (collect(['2018/2019', '2019/2020', '2020/2021', '2021/2022'])->reverse() as $item)
                    <tr>
                      ...
                      <td>
                        <a href="{{ route('views.transaction-records.form') }}" class="btn btn-primary btn-sm">Rekam</a>
                      </td>
                    </tr>
                  @endforeach
                </tbody>
