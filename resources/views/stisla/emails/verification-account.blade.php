                ...
                <tr>
                  <td style="padding:0 35px;">
                    <h1 style="color:#1e1e2d; font-weight:500; margin:0;font-size:32px;font-family:'Rubik',sans-serif;">
                      {{ $isVerificationCode ? 'Kode Verifikasi' : 'Link Verifikasi' }}
                    </h1>
                    <span style="display:inline-block; vertical-align:middle; margin:29px 0 26px; border-bottom:1px solid #cecece; width:100px;"></span>
                    <p style="color:#455056; font-size:15px;line-height:24px; margin:0;">
                      {{ $isVerificationCode? 'Terima kasih telah bergabung dengan kami. Untuk menggunakan akun anda dalam sistem, silakan masukkan kode verifikasi untuk memverifikasi akun.': 'Terima kasih telah bergabung dengan kami. Untuk menggunakan akun anda dalam sistem, silakan klik tautan berikut untuk memverifikasi akun.' }}
                    </p>
                    ...
                    @else
                      <a href="{{ $link = route('verify', [$user->email_token]) }}"
                        style="background:#6777ef;text-decoration:none !important; font-weight:500; margin-top:35px; color:#fff;text-transform:uppercase; font-size:14px;padding:10px 24px;display:inline-block;border-radius:50px;">
                        {{ __('Verifikasi') }}
                      </a>
                    @endif
